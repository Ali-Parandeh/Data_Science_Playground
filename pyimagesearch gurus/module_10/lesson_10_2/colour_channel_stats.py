...
# and feature vector
image_paths = sorted(list(paths.list_images('../img')))
index = {}
...
# loop over the file names in the dictionary
for (i, k) in enumerate(keys):
    # if this is the first image, ignore it
    if k == 'trex_01.png':
        continue

    # print colour channel summary stats for raptor images
    if any(k == f'raptors_0{i}.png' for i in range(1, 3)):
        print(k, index[k])
...
# print Euclidean distance between raptor images
print(dist.euclidean(index['raptors_01.png'], index['raptors_02.png']))
