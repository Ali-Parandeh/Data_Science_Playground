...
# By utilizing masks, we are able to apply our computation only to the
# specific regions of the image that interest us — in this example,
# we simply wanted to examine the distribution of the blue sky and ocean.
