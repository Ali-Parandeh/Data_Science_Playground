...
# To support this, you can use the special expression $@ (dollar sign 
# immediately followed by at-sign) to mean "all of the command-line parameters given to the script".
...
# Assignment
# 1. Edit the script count-records.sh with Nano and fill in the 
# two ____ placeholders with $@ and -l (the letter) 
# respectively so that it counts the number of lines 
